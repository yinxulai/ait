  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed top-1/2 left-1/2 z-50 grid max-h-[92vh] w-[min(calc(100vw-2rem),1120px)] -translate-x-1/2 -translate-y-1/2 gap-0 overflow-hidden rounded-3xl border bg-popover bg-clip-padding text-sm text-popover-foreground shadow-2xl duration-200 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95",
          className
        )}
        {...props}
      >
